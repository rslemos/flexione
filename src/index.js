var pl = require('../tau-prolog/code/core/beta.js');
require('../tau-prolog/code/lists/beta.js')(pl);

console.debug('tau-prolog', pl);
...
var program = verbos_pl + basev_pl;

var session = pl.create(1000);
console.debug(session);
console.debug(session.consult(program));
